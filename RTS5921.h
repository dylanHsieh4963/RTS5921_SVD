 ...
 * @version  0.01
 * @date     01. July 2025
 * @note     Generated by SVDConv V3.3.42 on Tuesday, 01.07.2025 14:11:44
 *           from File 'RTS5921.svd',
 *           last modified on Tuesday, 01.07.2025 06:11:41
 */
...
typedef struct {                                /*!< (@ 0x40100000) SYSTEM Structure                                           */
  ...
  union {
    ...
    struct {
      __IOM uint32_t USB_DPHY   : 1;            /*!< [0..0] USB DPHY Clock Power Control                                       */
      __IOM uint32_t GPIO       : 1;            /*!< [1..1] GPIO Clock Power Control                                           */
      __IOM uint32_t RC24MREF   : 1;            /*!< [2..2] RC 24M Ref Clock Power Control                                     */
      __IOM uint32_t RC24MCAL   : 1;            /*!< [3..3] RC 24M Cal Clock Power Control                                     */
      __IOM uint32_t TACHO      : 1;            /*!< [4..4] Tachometer Clock Power Control                                     */
      __IOM uint32_t RC32KREF   : 1;            /*!< [5..5] RC 32K Ref Clock Power Control                                     */
      __IOM uint32_t RC32KCAL   : 1;            /*!< [6..6] RC 32K Cal Clock Power Control                                     */
      __IOM uint32_t WDT        : 1;            /*!< [7..7] Watchdog Timer Clock Power Control                                 */
      __IOM uint32_t PWM        : 1;            /*!< [8..8] PWM Clock Power Control                                            */
      __IOM uint32_t TMR        : 1;            /*!< [9..9] Timer Clock Power Control                                          */
      __IOM uint32_t CRC        : 1;            /*!< [10..10] CRC Clock Power Control                                          */
      __IOM uint32_t MATRIX     : 1;            /*!< [11..11] Matrix Clock Power Control                                       */
      __IOM uint32_t UART       : 1;            /*!< [12..12] UART Clock Power Control                                         */
      __IOM uint32_t ADC        : 1;            /*!< [13..13] ADC Clock Power Control                                          */
      __IOM uint32_t STRIP      : 1;            /*!< [14..14] Strip Clock Power Control                                        */
      __IOM uint32_t I2C        : 1;            /*!< [15..15] I2C Clock Power Control                                          */
      __IOM uint32_t SPIS       : 1;            /*!< [16..16] SPI Slave Clock Power Control                                    */
      __IOM uint32_t SPIM       : 1;            /*!< [17..17] SPI Master Clock Power Control                                   */
      __IOM uint32_t I3C        : 1;            /*!< [18..18] I3C Clock Power Control                                          */
      __IOM uint32_t APB        : 1;            /*!< [19..19] APB Clock Power Control                                          */
      __IOM uint32_t USB        : 1;            /*!< [20..20] USB Clock Power Control                                          */
      __IOM uint32_t SYS        : 1;            /*!< [21..21] System Clock Power Control                                       */
            uint32_t            : 8;
  ...
  union {
    ...
    struct {
      __IOM uint32_t SEL_CLK_TACH_CTS2_ROOT : 2;/*!< [1..0] TACH Clock Source Select                                           */
      __IOM uint32_t SEL_CLK_TMR_CTS2_ROOT : 2; /*!< [3..2] TMR Clock Source Select                                            */
      __IOM uint32_t SEL_CLK_TURBO_MEM_COMP_CTS2_ROOT : 2;/*!< [5..4] Turbo Mem Comp Clock Source Select                       */
      __IOM uint32_t SEL_CLK_DOT_MATRIX_LED_CTS2_ROOT : 2;/*!< [7..6] Dot Matrix LED Clock Source Select                       */
      __IOM uint32_t SEL_CLK_UART_CTS2_ROOT : 2;/*!< [9..8] UART Clock Source Select                                           */
      __IOM uint32_t SEL_CLK_ADC_CTS2_ROOT : 2; /*!< [11..10] ADC Clock Source Select                                          */
      __IOM uint32_t SEL_CLK_STRIP_CTS2_ROOT : 2;/*!< [13..12] STRIP Clock Source Select                                       */
      __IOM uint32_t SEL_CLK_I2C_CTS2_ROOT : 2; /*!< [15..14] I2C Clock Source Select                                          */
      __IOM uint32_t SEL_CLK_SPI_S_CTS2_ROOT : 2;/*!< [17..16] SPI Slave Clock Source Select                                   */
      __IOM uint32_t SEL_CLK_SPI_M_CTS2_ROOT : 2;/*!< [19..18] SPI Master Clock Source Select                                  */
      __IOM uint32_t SEL_CLK_LED_CTS2_ROOT : 2; /*!< [21..20] LED Clock Source Select                                          */
      __IOM uint32_t SEL_CLK_ASYNC_BUS_CTS2_ROOT : 2;/*!< [23..22] Async Bus Clock Source Select                               */
      __IOM uint32_t SEL_CLK_SYS_CTS2_ROOT : 2; /*!< [25..24] System Clock Source Select                                       */
            uint32_t            : 6;
    } PERICLKSEL0_b;
  } ;
  ...
  union {
    ...
    struct {
      __IOM uint32_t STRIP0     : 1;            /*!< [0..0] STRIP0 clock enable: 0=Disable, 1=Enable                           */
      __IOM uint32_t STRIP1     : 1;            /*!< [1..1] STRIP1 clock enable: 0=Disable, 1=Enable                           */
      __IOM uint32_t STRIP2     : 1;            /*!< [2..2] STRIP2 clock enable: 0=Disable, 1=Enable                           */
      __IOM uint32_t STRIP3     : 1;            /*!< [3..3] STRIP3 clock enable: 0=Disable, 1=Enable                           */
      __IOM uint32_t STRIP4     : 1;            /*!< [4..4] STRIP4 clock enable: 0=Disable, 1=Enable                           */
      __IOM uint32_t STRIP5     : 1;            /*!< [5..5] STRIP5 clock enable: 0=Disable, 1=Enable                           */
      __IOM uint32_t STRIP6     : 1;            /*!< [6..6] STRIP6 clock enable: 0=Disable, 1=Enable                           */
      __IOM uint32_t STRIP7     : 1;            /*!< [7..7] STRIP7 clock enable: 0=Disable, 1=Enable                           */
      __IOM uint32_t STRIP8     : 1;            /*!< [8..8] STRIP8 clock enable: 0=Disable, 1=Enable                           */
      __IOM uint32_t I2C0       : 1;            /*!< [9..9] I2C0 clock enable: 0=Disable, 1=Enable                             */
      __IOM uint32_t I2C1       : 1;            /*!< [10..10] I2C1 clock enable: 0=Disable, 1=Enable                           */
      __IOM uint32_t I2C2       : 1;            /*!< [11..11] I2C2 clock enable: 0=Disable, 1=Enable                           */
      __IOM uint32_t I2CDBG     : 1;            /*!< [12..12] I2C Debug clock enable: 0=Disable, 1=Enable                      */
      __IOM uint32_t SWD        : 1;            /*!< [13..13] SWD clock enable: 0=Disable, 1=Enable                            */
      __IOM uint32_t SPIS       : 1;            /*!< [14..14] SPIS clock enable: 0=Disable, 1=Enable                           */
      __IOM uint32_t SPIM       : 1;            /*!< [15..15] SPIM clock enable: 0=Disable, 1=Enable                           */
      __IOM uint32_t I3C        : 1;            /*!< [16..16] I3C clock enable: 0=Disable, 1=Enable                            */
      __IOM uint32_t USB        : 1;            /*!< [17..17] USB clock enable: 0=Disable, 1=Enable                            */
      __IOM uint32_t EXTR_SPIC  : 1;            /*!< [18..18] EXTR SPIC clock enable: 0=Disable, 1=Enable                      */
      __IOM uint32_t INTR_SPIC  : 1;            /*!< [19..19] INTR SPIC clock enable: 0=Disable, 1=Enable                      */
      __IOM uint32_t DMA        : 1;            /*!< [20..20] DMA clock enable: 0=Disable, 1=Enable                            */
      __IOM uint32_t CPU        : 1;            /*!< [21..21] CPU clock enable: 0=Disable, 1=Enable                            */
            uint32_t            : 10;
    } PERICLKPWR0_b;
  } ;
  ...
  union {
    ...
    struct {
      __IOM uint32_t RC24REF    : 1;            /*!< [0..0] RC24REF clock enable: 0=Disable, 1=Enable                          */
      __IOM uint32_t RC24CAL    : 1;            /*!< [1..1] RC24CAL clock enable: 0=Disable, 1=Enable                          */
      __IOM uint32_t RC32REF    : 1;            /*!< [2..2] RC32REF clock enable: 0=Disable, 1=Enable                          */
      __IOM uint32_t RC32CAL    : 1;            /*!< [3..3] RC32CAL clock enable: 0=Disable, 1=Enable                          */
      __IOM uint32_t TACHO0     : 1;            /*!< [4..4] TACHO0 clock enable: 0=Disable, 1=Enable                           */
      __IOM uint32_t TACHO1     : 1;            /*!< [5..5] TACHO1 clock enable: 0=Disable, 1=Enable                           */
      __IOM uint32_t TACHO2     : 1;            /*!< [6..6] TACHO2 clock enable: 0=Disable, 1=Enable                           */
      __IOM uint32_t TACHO3     : 1;            /*!< [7..7] TACHO3 clock enable: 0=Disable, 1=Enable                           */
      __IOM uint32_t TMR0       : 1;            /*!< [8..8] TMR0 clock enable: 0=Disable, 1=Enable                             */
      __IOM uint32_t TMR1       : 1;            /*!< [9..9] TMR1 clock enable: 0=Disable, 1=Enable                             */
      __IOM uint32_t TMR2       : 1;            /*!< [10..10] TMR2 clock enable: 0=Disable, 1=Enable                           */
      __IOM uint32_t TMR3       : 1;            /*!< [11..11] TMR3 clock enable: 0=Disable, 1=Enable                           */
      __IOM uint32_t USB_DPHY   : 1;            /*!< [12..12] USB_DPHY clock enable: 0=Disable, 1=Enable                       */
      __IOM uint32_t GPIO       : 1;            /*!< [13..13] GPIO clock enable: 0=Disable, 1=Enable                           */
      __IOM uint32_t WDT        : 1;            /*!< [14..14] WDT clock enable: 0=Disable, 1=Enable                            */
      __IOM uint32_t URAT       : 1;            /*!< [15..15] URAT clock enable: 0=Disable, 1=Enable                           */
      __IOM uint32_t ADC        : 1;            /*!< [16..16] ADC clock enable: 0=Disable, 1=Enable                            */
      __IOM uint32_t CRC        : 1;            /*!< [17..17] CRC clock enable: 0=Disable, 1=Enable                            */
      __IOM uint32_t MATRIX     : 1;            /*!< [18..18] MATRIX clock enable: 0=Disable, 1=Enable                         */
      __IOM uint32_t EFUSE      : 1;            /*!< [19..19] EFUSE clock enable: 0=Disable, 1=Enable                          */
            uint32_t            : 12;
    } PERICLKPWR1_b;
  } ;
  ...
  union {
    ...
    struct {
      __IOM uint32_t LEDPWM0    : 1;            /*!< [0..0] LEDPWM0 clock enable: 0=Disable, 1=Enable                          */
      __IOM uint32_t LEDPWM1    : 1;            /*!< [1..1] LEDPWM1 clock enable: 0=Disable, 1=Enable                          */
      __IOM uint32_t LEDPWM2    : 1;            /*!< [2..2] LEDPWM2 clock enable: 0=Disable, 1=Enable                          */
      __IOM uint32_t LEDPWM3    : 1;            /*!< [3..3] LEDPWM3 clock enable: 0=Disable, 1=Enable                          */
      __IOM uint32_t LEDPWM4    : 1;            /*!< [4..4] LEDPWM4 clock enable: 0=Disable, 1=Enable                          */
      __IOM uint32_t LEDPWM5    : 1;            /*!< [5..5] LEDPWM5 clock enable: 0=Disable, 1=Enable                          */
      __IOM uint32_t LEDPWM6    : 1;            /*!< [6..6] LEDPWM6 clock enable: 0=Disable, 1=Enable                          */
      __IOM uint32_t LEDPWM7    : 1;            /*!< [7..7] LEDPWM7 clock enable: 0=Disable, 1=Enable                          */
      __IOM uint32_t LEDPWM8    : 1;            /*!< [8..8] LEDPWM8 clock enable: 0=Disable, 1=Enable                          */
      __IOM uint32_t LEDPWM9    : 1;            /*!< [9..9] LEDPWM9 clock enable: 0=Disable, 1=Enable                          */
      __IOM uint32_t LEDPWM10   : 1;            /*!< [10..10] LEDPWM10 clock enable: 0=Disable, 1=Enable                       */
      __IOM uint32_t LEDPWM11   : 1;            /*!< [11..11] LEDPWM11 clock enable: 0=Disable, 1=Enable                       */
      __IOM uint32_t LEDPWM12   : 1;            /*!< [12..12] LEDPWM12 clock enable: 0=Disable, 1=Enable                       */
      __IOM uint32_t LEDPWM13   : 1;            /*!< [13..13] LEDPWM13 clock enable: 0=Disable, 1=Enable                       */
      __IOM uint32_t LEDPWM14   : 1;            /*!< [14..14] LEDPWM14 clock enable: 0=Disable, 1=Enable                       */
      __IOM uint32_t LEDPWM15   : 1;            /*!< [15..15] LEDPWM15 clock enable: 0=Disable, 1=Enable                       */
      __IOM uint32_t LEDPWM16   : 1;            /*!< [16..16] LEDPWM16 clock enable: 0=Disable, 1=Enable                       */
      __IOM uint32_t LEDPWM17   : 1;            /*!< [17..17] LEDPWM17 clock enable: 0=Disable, 1=Enable                       */
      __IOM uint32_t LEDPWM18   : 1;            /*!< [18..18] LEDPWM18 clock enable: 0=Disable, 1=Enable                       */
      __IOM uint32_t LEDPWM19   : 1;            /*!< [19..19] LEDPWM19 clock enable: 0=Disable, 1=Enable                       */
      __IOM uint32_t LEDPWM20   : 1;            /*!< [20..20] LEDPWM20 clock enable: 0=Disable, 1=Enable                       */
      __IOM uint32_t LEDPWM21   : 1;            /*!< [21..21] LEDPWM21 clock enable: 0=Disable, 1=Enable                       */
      __IOM uint32_t LEDPWM22   : 1;            /*!< [22..22] LEDPWM22 clock enable: 0=Disable, 1=Enable                       */
      __IOM uint32_t LEDPWM23   : 1;            /*!< [23..23] LEDPWM23 clock enable: 0=Disable, 1=Enable                       */
      __IOM uint32_t LEDPWM24   : 1;            /*!< [24..24] LEDPWM24 clock enable: 0=Disable, 1=Enable                       */
      __IOM uint32_t LEDPWM25   : 1;            /*!< [25..25] LEDPWM25 clock enable: 0=Disable, 1=Enable                       */
      __IOM uint32_t LEDPWM26   : 1;            /*!< [26..26] LEDPWM26 clock enable: 0=Disable, 1=Enable                       */
      __IOM uint32_t LEDPWM27   : 1;            /*!< [27..27] LEDPWM27 clock enable: 0=Disable, 1=Enable                       */
      __IOM uint32_t LEDPWM28   : 1;            /*!< [28..28] LEDPWM28 clock enable: 0=Disable, 1=Enable                       */
      __IOM uint32_t LEDPWM29   : 1;            /*!< [29..29] LEDPWM29 clock enable: 0=Disable, 1=Enable                       */
      __IOM uint32_t LEDPWM30   : 1;            /*!< [30..30] LEDPWM30 clock enable: 0=Disable, 1=Enable                       */
      __IOM uint32_t LEDPWM31   : 1;            /*!< [31..31] LEDPWM31 clock enable: 0=Disable, 1=Enable                       */
    } PERICLKPWR2_b;
  } ;
  ...
  union {
    ...
    struct {
      __IOM uint32_t TACHO0     : 1;            /*!< [0..0] TACHO0 clock enable: 0=Disable, 1=Enable                           */
      __IOM uint32_t TACHO1     : 1;            /*!< [1..1] TACHO1 clock enable: 0=Disable, 1=Enable                           */
      __IOM uint32_t TACHO2     : 1;            /*!< [2..2] TACHO2 clock enable: 0=Disable, 1=Enable                           */
      __IOM uint32_t TACHO3     : 1;            /*!< [3..3] TACHO3 clock enable: 0=Disable, 1=Enable                           */
      __IOM uint32_t TMR0       : 1;            /*!< [4..4] TMR0 clock enable: 0=Disable, 1=Enable                             */
      __IOM uint32_t TMR1       : 1;            /*!< [5..5] TMR1 clock enable: 0=Disable, 1=Enable                             */
      __IOM uint32_t TMR2       : 1;            /*!< [6..6] TMR2 clock enable: 0=Disable, 1=Enable                             */
      __IOM uint32_t TMR3       : 1;            /*!< [7..7] TMR3 clock enable: 0=Disable, 1=Enable                             */
      __IOM uint32_t GPIO       : 1;            /*!< [8..8] GPIO clock enable: 0=Disable, 1=Enable                             */
      __IOM uint32_t WDT        : 1;            /*!< [9..9] WDT clock enable: 0=Disable, 1=Enable                              */
      __IOM uint32_t UART       : 1;            /*!< [10..10] UART clock enable: 0=Disable, 1=Enable                           */
      __IOM uint32_t ADC        : 1;            /*!< [11..11] ADC clock enable: 0=Disable, 1=Enable                            */
      __IOM uint32_t STRIP0     : 1;            /*!< [12..12] STRIP0 clock enable: 0=Disable, 1=Enable                         */
      __IOM uint32_t STRIP1     : 1;            /*!< [13..13] STRIP1 clock enable: 0=Disable, 1=Enable                         */
      __IOM uint32_t STRIP2     : 1;            /*!< [14..14] STRIP2 clock enable: 0=Disable, 1=Enable                         */
      __IOM uint32_t STRIP3     : 1;            /*!< [15..15] STRIP3 clock enable: 0=Disable, 1=Enable                         */
      __IOM uint32_t STRIP4     : 1;            /*!< [16..16] STRIP4 clock enable: 0=Disable, 1=Enable                         */
      __IOM uint32_t STRIP5     : 1;            /*!< [17..17] STRIP5 clock enable: 0=Disable, 1=Enable                         */
      __IOM uint32_t STRIP6     : 1;            /*!< [18..18] STRIP6 clock enable: 0=Disable, 1=Enable                         */
      __IOM uint32_t STRIP7     : 1;            /*!< [19..19] STRIP7 clock enable: 0=Disable, 1=Enable                         */
      __IOM uint32_t STRIP8     : 1;            /*!< [20..20] STRIP8 clock enable: 0=Disable, 1=Enable                         */
      __IOM uint32_t I2C0       : 1;            /*!< [21..21] I2C0 clock enable: 0=Disable, 1=Enable                           */
      __IOM uint32_t I2C1       : 1;            /*!< [22..22] I2C1 clock enable: 0=Disable, 1=Enable                           */
      __IOM uint32_t I2C2       : 1;            /*!< [23..23] I2C2 clock enable: 0=Disable, 1=Enable                           */
      __IOM uint32_t I2CDBG     : 1;            /*!< [24..24] I2C Debug clock enable: 0=Disable, 1=Enable                      */
      __IOM uint32_t SPIS       : 1;            /*!< [25..25] SPIS clock enable: 0=Disable, 1=Enable                           */
      __IOM uint32_t SPIM       : 1;            /*!< [26..26] SPIM clock enable: 0=Disable, 1=Enable                           */
      __IOM uint32_t CRC        : 1;            /*!< [27..27] CRC clock enable: 0=Disable, 1=Enable                            */
      __IOM uint32_t MATRIX     : 1;            /*!< [28..28] MATRIX clock enable: 0=Disable, 1=Enable                         */
      __IOM uint32_t USB        : 1;            /*!< [29..29] USB clock enable: 0=Disable, 1=Enable                            */
            uint32_t            : 2;
    } APBCLKPWR0_b;
  } ;
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t sel_clk_adc_async_bus : 1; /*!< [30..30] ADC Async Bus Clock Source Select                                */
            uint32_t            : 1;
    } PERICLKSEL1_b;
  } ;
...
typedef struct {                                /*!< (@ 0x40122100) DOTMTX0 Structure                                          */
  ...
  union {
    __IOM uint32_t INT;                         /*!< (@ 0x00000018) Interrupt control register for matrix operations.          */
    
    struct {
      __IOM uint32_t INTSTS     : 1;            /*!< [0..0] Interrupt flag for matrix operation.                               */
      __IOM uint32_t INTRDY     : 1;            /*!< [1..1] Interrupt flag for APB ready without response.                     */
            uint32_t            : 30;
    } INT_b;
  } ;
  
  union {
    __IOM uint32_t STS;                         /*!< (@ 0x0000001C) Status register showing current scan position
                                                                    and cycle count.                                           */
