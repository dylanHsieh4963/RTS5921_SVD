 ...
 * @version  0.01
 * @date     01. July 2025
 * @note     Generated by SVDConv V3.3.42 on Tuesday, 01.07.2025 17:11:37
 *           from File 'RTS5921.svd',
 *           last modified on Tuesday, 01.07.2025 09:11:24
 */
...
typedef struct {                                /*!< (@ 0x40100000) SYSTEM Structure                                           */
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t URAT_IP    : 1;            /*!< [15..15] URAT clock enable: 0=Disable, 1=Enable                           */
