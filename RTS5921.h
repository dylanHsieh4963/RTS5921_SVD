 ...
 * @version  0.01
 * @date     11. June 2025
 * @note     Generated by SVDConv V3.3.42 on Wednesday, 11.06.2025 13:32:45
 *           from File 'RTS5921.svd',
 *           last modified on Wednesday, 11.06.2025 05:32:14
 */
...
typedef struct {                                /*!< (@ 0x40002000) DMA Structure                                              */
  ...
  union {
    ...
    struct {
      ...
      __IM  uint32_t Undefined  : 3;            /*!< [31..29] Reserved                                                         */
    } CTL0_L_b;
  } ;
  ...
  union {
    ...
    struct {
      ...
      __OM  uint32_t CH_EN_WE   : 8;            /*!< [15..8] Channel enable write enable.                                      */
            uint32_t            : 16;
    } CHENREG_b;
  } ;
